...
export const InventoryMovementsReportPdf: React.FC<InventoryMovementsReportProps> = ({
    tenantName,
    branchName,
    dateRange,
    summary,
    ...
    const tableColumns = [
        ...
        { header: 'Before', accessor: 'beforeStock', width: '8%', align: 'right' as const },
        { header: 'After', accessor: 'afterStock', width: '8%', align: 'right' as const },
        { header: 'Adjustment', accessor: 'adjustment', width: '10%', align: 'right' as const },
