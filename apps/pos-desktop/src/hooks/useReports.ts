...
export const reportsKeys = {
  ...
  loyaltySummary: (params: ReportListParams) =>
    [
      ...reportsKeys.all,
      "loyalty",
      "summary",
  ...
  loyaltyTransactionsList: (params: ReportListParams) =>
    [
      ...reportsKeys.all,
      "loyalty",
      "transactions",
...
export const useReportsDebts = (
  ...
  return useQuery({
    queryKey: reportsKeys.debts(from.toISOString(), to.toISOString(), branchId),
...
// ============================================================
// LOYALTY REPORT HOOKS
// ============================================================

/**
 * Hook to fetch loyalty summary report
 * GET /reports/loyalty
 */
export const useLoyaltySummaryReport = (
  params: ReportListParams,
  options: ReportsQueryOptions = {},
): UseQueryResult<LoyaltySummaryData, Error> => {
  const { enabled = true } = options;

  return useQuery({
    queryKey: reportsKeys.loyaltySummary(params),
    queryFn: () => reportsApi.getLoyaltySummary(params),
    enabled,
    staleTime: 60000,
  });
};
...
/**
 * Hook to fetch loyalty transactions list with pagination
...
export const useLoyaltyTransactionsReport = (
  ...
  return useQuery({
    queryKey: reportsKeys.loyaltyTransactionsList(params),
    queryFn: () => reportsApi.getLoyaltyTransactionsList(params),
    enabled,
    staleTime: 60000,
  });
};
