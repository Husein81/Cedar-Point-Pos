        ...
        <Shad.AlertDialogHeader>
          ...
          <Shad.AlertDialogDescription asChild>
            <div className="space-y-3 text-muted-foreground">
              <p>
                You are about to set <strong>{currencyName} ({currencyCode})</strong> as your
                base currency for accounting and reporting.
              </p>
              ...
              <div className="bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded-lg p-3 space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-amber-700 dark:text-amber-300">
                  <li>All reports will use this currency as the primary denomination</li>
                  <li>Exchange rates for other currencies will be relative to this currency</li>
                  <li>Past orders retain their original currency and exchange rate snapshots</li>
                  <li>This change affects future orders and reporting only</li>
                </ul>
              </div>

              <p className="text-sm">
                The exchange rate for {currencyCode} will automatically be set to 1.00.
              </p>
            </div>
          </Shad.AlertDialogDescription>
        </Shad.AlertDialogHeader>
        <Shad.AlertDialogFooter>
          <Shad.AlertDialogCancel disabled={isLoading}>Cancel</Shad.AlertDialogCancel>
          <Button
            onClick={onConfirm}
