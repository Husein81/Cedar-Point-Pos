...
export const OrderTabs = ({ className }: Props) => {
  const {
    tabs,
    activeTabId,
    setActiveTab,
  ...
  return (
    <>
      {/* Tabs Container */}
      <div
        className={cn("flex items-end gap-1 px-1 pt-1 bg-muted/30", className)}
      >
        {tabs.map((tab) => {
          ...
          return (
            <div
              ...
              className={cn(
                ...
                "min-w-35 max-w-55 hover:bg-background hover:text-foreground",
