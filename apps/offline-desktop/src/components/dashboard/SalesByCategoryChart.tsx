...
import type { CategorySalesPoint } from "@/shared/models";
          ...
          <PieChart>
            ...
            <Tooltip
              formatter={(value, _name, item) => {
                const category = (item as { payload?: CategorySalesPoint })
                  .payload;
                return [
                  `${formatMoney(Number(value) || 0, currencySymbol)} · ${category?.value ?? 0} items`,
                  category?.name ?? "",
                ];
              }}
