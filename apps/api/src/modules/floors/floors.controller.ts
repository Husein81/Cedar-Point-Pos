...
export class FloorsController {
     ...
     */
    @Get('/branch/:branchId')
    getFloorsByBranch(@Req() req: Request) {
     ...
     */
    @Get('/:id/tables')
    getTablesByFloor(@Req() req: Request) {
        const user = req.user as { tenantId: string };
        const { id } = req.params;
