/**
 * Constants for tables and floors feature
 * Centralizes magic numbers and strings for consistency
 */

/**
 * Table capacity limits and defaults
 */
...
export const TOAST_MESSAGES = {
    TABLE: {
        ...
        STATUS_UPDATED: (status: string) => `Table status updated to ${status.toLowerCase()}`,
