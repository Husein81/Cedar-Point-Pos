...
export const TopProductsReportPdf: React.FC<TopProductsReportProps> = ({
    ...
    const tableColumns = [
        ...
        { header: 'Qty Sold', accessor: 'qtySold', width: '15%', align: 'right' as const },
        { header: 'Avg Unit Price', accessor: 'avgUnitPrice', width: '17.5%', align: 'right' as const, format: formatCurrency },
        { header: 'Revenue', accessor: 'revenue', width: '17.5%', align: 'right' as const, format: formatCurrency },
    ];
